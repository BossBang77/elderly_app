...
import 'package:health_application/ui/base/line_date_picker/date_time_style.dart';
import 'package:health_application/ui/base/line_date_picker/date_widget.dart';
...
class DatePicker extends StatefulWidget {
  ...
  DatePicker(
    ...
    this.deactivatedColor = Colors.black,
...
class _DatePickerState extends State<DatePicker> {
  ...
  void initState() {
    ...
    this.selectedDateStyle = widget.dateTextStyle
        .copyWith(color: widget.selectedTextColor, fontSize: 17);
    this.selectedMonthStyle = widget.monthTextStyle
        .copyWith(color: widget.selectedTextColor, fontSize: 15);
...
//            print("Inside Inactive dates.");
          ...
          return DateWidget(
            ...
            selectionColor: isSelected ? widget.selectionColor : color.grey10,
