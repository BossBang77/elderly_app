...
import '../../register_profile/model/sub_menu_model.dart';
import '../../ui-extensions/color.dart';

class FoodAllergiesWidget extends StatelessWidget {
  const FoodAllergiesWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HealthProfileBloc, HealthProfileState>(
      builder: (context, state) {
        ...
        var list = [...state.currentProfile.allergicFoods];
        ...
        return Scaffold(
          ...
          appBar: appBar(
              onBack: () {
                addEvent(context, FormFillType(type: FillType.resetAllergies));
              },
              title: 'การแพ้อาหาร'),
          body: Column(
                    ...
                    Expanded(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        String isCheckMol = list
                            .firstWhere(
                                (element) => element.code == item.keyCode,
                                orElse: () => SubMenuModel())
                            .code;
