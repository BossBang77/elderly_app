  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HealthProfileBloc, HealthProfileState>(
      builder: (context, state) {
        MasterData congenitalDisease = BlocProvider.of<MasterDataBloc>(context)
            .state
            .congenitalDiseaseMaster;
        var list = [...state.currentProfile.congenitalDisease];
        ...
        return Scaffold(
          ...
          appBar: appBar(
              onBack: () {
                addEvent(context, FormFillType(type: FillType.resetDisease));
              },
              title: 'โรคประจำตัว'),
          body: Column(
