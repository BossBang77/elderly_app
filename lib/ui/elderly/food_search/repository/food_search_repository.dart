...
abstract class FoodSearchRepositoryProtocol {
  Future<Either<Failure, FoodSearchResponse>> searchFoodWith(
...
class FoodSearchRepository implements FoodSearchRepositoryProtocol {
  ...
  late FoodSearchService _foodSearchService =
      FoodSearchService(networkProvider.dioClient());
  ResponseHandler jsonResponseHandler = JsonResponseHandler();

  @override
  Future<Either<Failure, FoodSearchResponse>> searchFoodWith(
      FoodSearchRequest request) async {
    try {
      final HttpResponse response =
          await _foodSearchService.searchFood(request.toJson());
