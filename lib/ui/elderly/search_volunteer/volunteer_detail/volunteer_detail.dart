                  ...
                  child: InkWell(
                    onTap: () {
                      context.read<SearchVolunteerBloc>().add(
                          Changeview(view: SearchVolunteerView.searchResult));
                    },
                    child: CircleAvatar(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          textSubtitle18Blod(
                              volunteer.name, ColorTheme().black87),
                          const SizedBox(
                            height: 5,
                          ),
                          IntrinsicHeight(
                            child: Row(
                              children: [
                                ...
                                textButton2(volunteer.rating.toString(),
                                    color.greyText),
                                const SizedBox(
                                  width: 10,
                                ),
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        border:
                                            Border.all(color: color.GreyBorder),
                                        color: color.grey10,
                          ...
                          textH7(
                              volunteer.description.isNoData(), color.black87),
                          const SizedBox(
                            height: 20,
                          ),
                          ...
                          Row(
                            children: [
                              Flexible(
                                child: Column(
                                  children: [
                                    textButton1(review.rating.toString(),
                                        color.black87),
                                    textButton2(
                          ...
                          for (int i = 0; i < reviewerList.length; i++)
                            Column(
                              ...
                              children: [
                                ...
                                StarRate(context, 1),
                                textButton2(
                                    reviewerList[i].description.isNoData(),
                                    color.greyText),
                                Divider(),
                              ],
                            ),
