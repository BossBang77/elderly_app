...
class _SearchBoxWidgetState extends State<SearchBoxWidget> {
  ...
  bool _shouldDisplayFilterButton(bool hasText, bool hasFocus) {
              ...
              child: Row(
                ...
                children: [
                  AnimatedContainer(
                      ...
                      height: 48,
                      width: _shouldDisplayFilterButton(_hasText, _hasFocus)
                          ? hideWidth
                          : expandedWidth,
                      child: Focus(
                  ...
                  SizedBox(
                      ...
                      child: OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            backgroundColor: widget.shouldHighLightFilterButton
                                ? ColorTheme().blueText
                                : ColorTheme().white,
                            ...
                            side:
                                BorderSide(color: ColorTheme().GreyBackGround),
                          ),
                          onPressed: () {
                            widget.onFilterButtonTapped?.call();
                          },
                          child: SizedBox(
                            width: 24,
                            height: 24,
                            child: Image.asset(
                                widget.shouldHighLightFilterButton
                                    ? 'assets/images/filter_icon_white.png'
