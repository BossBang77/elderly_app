                                          ...
                                          children: [
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Center(child: textBody1('${state.consumeUnit} จาน', ColorTheme().blueText))
                                              ),
                                            ),
                                            SizedBox(width: 16),
                                            GestureDetector(
                                              onTap: () {
                                                context.read<FoodLogDetailBloc>().add(FoodLogDetailConsumeUnitSubstracted());
                                              },
                                              child: Container(
                                                width: 57,
                                                height: 48,
                                                ...
                                                child: Center(child: textBody1('-', ColorTheme().grey50)),
                                              ),
                                            ),
                                            SizedBox(width: 16),
                                            GestureDetector(
                                              onTap: () {
                                                context.read<FoodLogDetailBloc>().add(FoodLogDetailConsumeUnitAdded());
                                              },
                                              child: Container(
                                                width: 57,
                                                height: 48,
                                                ...
                                                child: Center(child: textBody1('+', ColorTheme().white)),
                                              ),
                                            )
                                          ],
                                        ),
                      ...
                      Container(
                        padding: EdgeInsets.fromLTRB(16, 16, 16, 34),
                          child: ButtonGradient(
                            btnName: 'ยืนยัน',
                            onClick: () {
                              context.read<FoodLogDetailBloc>().add(FoodLogDetailSubmitted());
                            },
                          )
                      )
                    ],
