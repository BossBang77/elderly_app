              ...
              Column(
                ...
                children: [
                  ...
                  OtpTextField(
                    text: state.otp,
                    onChange: (value) {
                      context.read<RequestOtpBloc>().add(RequestOtpOtpValueChanged(value: value));
                    },
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          textCaption1(' ส่งรหัสอีกครั้ง ใน ', ColorTheme().black87),
                          textCaption1('${state.countDownTime}', ColorTheme().Primary),
                      ...
                      GestureDetector(
                        ...
                        child: textCaption1('ส่งรหัสอีกครั้ง', ColorTheme().Primary)
                      )
                    ],
                  )
                  //04:57 นาที
